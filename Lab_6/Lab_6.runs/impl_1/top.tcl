namespace eval ::optrace {
  variable script "/home/leonardo/PROJETO CV-QKD/04 - CURSOS/02 - LISTA DE EXERCICIOS/Lab_6/Lab_6.runs/impl_1/top.tcl"
...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache ./.Xil/Vivado-7938-leonardo-Precision-5860-Tower/incrSyn
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {/home/leonardo/PROJETO CV-QKD/04 - CURSOS/02 - LISTA DE EXERCICIOS/Lab_6/Lab_6.cache/wt} [current_project]
  set_property parent.project_path {/home/leonardo/PROJETO CV-QKD/04 - CURSOS/02 - LISTA DE EXERCICIOS/Lab_6/Lab_6.xpr} [current_project]
  set_property ip_output_repo {{/home/leonardo/PROJETO CV-QKD/04 - CURSOS/02 - LISTA DE EXERCICIOS/Lab_6/Lab_6.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{/home/leonardo/PROJETO CV-QKD/04 - CURSOS/02 - LISTA DE EXERCICIOS/Lab_6/Lab_6.runs/synth_1/top.dcp}}
